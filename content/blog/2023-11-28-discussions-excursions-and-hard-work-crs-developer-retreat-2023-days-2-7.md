...
<figure class="wp-block-image size-large is-resized">![](/images/2023/11/CRS_Budapest-1-3-1024x768.jpeg)<figcaption class="wp-element-caption">*During the guided tour through the Buda Castle district*</figcaption></figure>On Tuesday, after the morning's project work, a trip to Budapest was finally on the agenda. We reached the historic center of the Hungarian capital by minibus, metro and bus (some were still expecting to fly on by helicopter). As a local, Ervin had organized a guided tour through the [castle district of Buda](https://budacastlebudapest.com/).
...
<figure class="wp-block-image size-large is-resized">![](/images/2023/11/CRS_Budapest-5-1-1024x768.jpeg)<figcaption class="wp-element-caption">*The heroes on Budapest's Heroes' Square*</figcaption></figure>After this rather dark and gloomy history lesson we needed a short break in the Ecocafe where we got served another great coffee – which elicited an astonished "[Mannaggia](https://en.wiktionary.org/wiki/mannaggia)!" from our Italian friends.
...
<figure class="wp-block-image size-large is-resized">![](/images/2023/11/CRS_Budapest-7-1-1024x768.jpeg)<figcaption class="wp-element-caption">*A medieval feast for the Knights of the Core Rule Set*</figcaption></figure><div aria-hidden="true" class="wp-block-spacer" style="height:27px"></div>#### Project groups, quantitative testing and tautologies
...
<figure class="wp-block-image size-large is-resized">![](/images/2023/11/CRS_Budapest-2-1-1024x768.jpeg)<figcaption class="wp-element-caption">*Most of the time, the CRS Developer Retreat means hard work*</figcaption></figure><div aria-hidden="true" class="wp-block-spacer" style="height:27px"></div>#### Azure, the status page and (no) cyclomatic complexity
...
<figure class="wp-block-image size-large">![](/images/2023/11/CRS_Budapest-3-1-576x1024.jpeg)<figcaption class="wp-element-caption">*In the Metro to Budapest city center*</figcaption></figure>
