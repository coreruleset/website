...
- `REQUEST_HEADERS:Accept` must be empty
- `REQUEST_METHOD` must not be `OPTIONS`
- `REQUEST_HEADERS:User-Agent` must not include any of the strings "AppleWebKit", "Android", "Business", "Enterprise", or "Entreprise"
